...
## Do a random search for the best params
...
## OR, just init a random forest model with known params and then fit
good_known_params = {
    "n_estimators": 200,
    "min_samples_split": 4,
    "min_samples_leaf": 4,
...
plt.imshow(
    masked_raster, cmap="viridis", interpolation="none", vmin=min_value, vmax=max_value
)
plt.axis("off")
cbar = plt.colorbar()
...
plt.savefig(
    output_png, format="png", bbox_inches="tight", pad_inches=0, transparent=True
)
plt.show()
